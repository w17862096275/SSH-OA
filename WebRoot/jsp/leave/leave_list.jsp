...
<div class="action  divaction">
	...
	<div class="pages">
		<div class="forms">
		<s:form action="leave_pageSearchLeave.action" name="queryForm">
	...
	<!--增加报销单 区域 开始-->
		<table width="90%" border="0" cellspacing="0" cellpadding="0" class="list items">
	      ...
	      <tr>
	        ...
	        <td><s:property value="#leave.createEmp.name"/>请假<s:property value="#leave.leaveday"/>天</td>
	        ...
	        <td>
	       	 <a href="leave_getLeaveById.action?leave.id=<s:property value="#leave.id"/>"><img src="${images}/search.gif" width="16" height="15" /></a>
	       	  <s:if test="#leave.nextEmp.name == #session.employee.name">
