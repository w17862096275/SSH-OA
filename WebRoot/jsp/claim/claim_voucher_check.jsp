...
<body>
    <div class="action  divaction">
      ...
      <table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
         ...
         <tr>
           <td width="22%">审批人：<s:property value="#checkResult.sysEmployee.name" />(<s:property value="#checkResult.sysEmployee.sysPosition.nameCn" />)</td>
           <td width="27%">审批时间：<s:date name="#checkResult.checkTime" format="yyyy-MM-dd hh:mm:ss"/></td>
           <td width="30%">审核：<span class="red"><strong><s:property value="#checkResult.result" /></strong></span></td>
         </tr>
         <tr>
			...
			<tr>
			 ...
			 <tr>
				<td colspan="3" class="submit">
					...
					<s:hidden id="claimId" name="checkResult.bizClaimVoucher.id" value="%{claimVoucher.id}"/>
